...
export const AdminDashboard = () => {
  ...
  const fetchLeaveRequests = async () => {
    try {
      const response = await axios.get(
        "https://13.127.77.225/api/v1/leave/requests"
      );
  ...
  const handleAddEmployeeSubmit = async (employeeData) => {
    try {
      const response = await axios.post(
        "https://13.127.77.225/api/v1/employees",
        employeeData
      );
  ...
  const handleEditEmployeeSubmit = async (employeeData) => {
    try {
      const response = await axios.put(
        `https://13.127.77.225/api/v1/employees/${employeeData._id}`,
        employeeData
      );
      setSearchResults(
  ...
  const handleDeleteEmployeeSubmit = async (employeeId) => {
    try {
      await axios.delete(
        `https://13.127.77.225/api/v1/employees/${employeeId}`
      );
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.get(
        `https://13.127.77.225/api/v1/employees?search=${searchQuery}`
      );
  ...
  const handleApproveLeaveRequest = async (leaveRequestId, comment) => {
    try {
      const response = await axios.post(
        `https://13.127.77.225/api/v1/leave/requests/${leaveRequestId}/approve`,
        { comment }
      );
      setLeaveRequests(
  ...
  const handleDisapproveLeaveRequest = async (leaveRequestId, comment) => {
    try {
      const response = await axios.post(
        `https://13.127.77.225/api/v1/leave/requests/${leaveRequestId}/disapprove`,
        { comment }
      );
      setLeaveRequests(
        leaveRequests.map((lr) =>
